...
<body>
    ...
    <div class="container mt-4">
        <h2>Menambahkan Tenaga Kependidikan</h2>

        <form action="tampil_tendik.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="nomor_pegawai" id="nomor_pegawai" required>
        </div>
        <div class="form-group">
